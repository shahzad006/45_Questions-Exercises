...
let current_users = ["Ali","Zahid","shahzaD","Sohaib","Junaid","Tariq"];
let new_users = ["Ahmed","Asad","Sohaib","Ijaz","Manzoor","Shahzad"];
...
new_users.forEach(new_users => {
    ...
    let userNameTaken = current_users.some(current_users => current_users.toLocaleLowerCase() === new_userLower )
